...
# Updated command for Hydra-based configuration system
# Old: --cfg with_wm_rewind_4 --exp_name ... --batch_size 12
# New: experiment=with_wm_rewind_4 exp_name=... batch_size=12

accelerate launch --config_file /u/shuhan/projects/vla/scripts/accl_train/4gpu.yaml /u/shuhan/projects/vla/src/training/train.py experiment=with_wm_rewind_4 exp_name=with_wm_cr_0.8_re_0.8_sr_0.2_max_rewind_step_4_grad_accum_5 batch_size=12 gradient_accumulation_steps=5
