#!/bin/bash
#SBATCH --job-name get_64_cpus        # Job name
### Logging
...
# cd /u/shuhan/projects/vla/scripts/data_creation/highway_env
# python rollout_highway_fast_v0_dqn_meta_action_5_lanes_with_collision.py
